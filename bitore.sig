...
github.repositorypackage-lock.jsonon:
...
'".dirname": is'='==yargs(ARGS)).)"; /'"''t.verbose{
 ...
 a/content/packages/learn-github-packages/introduction-to-github-packages.md b/bitore.sig

similarity index 100%

rename from content/packages/learn-github-packages/introduction-to-github-packages.md

rename to bitore.sig'#' This workflow uses actions that are not certified by GitHub.''
...
.github/workflows/mergedcomplete.yml at 4074bf6

check: automerge

Check failure on line 1 in .github/workflows/mergedcomplete.yml

GitHub Actions

/ .github/workflows/mergedcomplete.yml

Invalid workflow file

The workflow is not valid. .github/workflows/mergedcomplete.yml (Line: 1, Col: 1): Unexpected value 'check'
...
UPDATE_METHOD: 'merge…packages.md to bitore.sig
...
Rename content/packages/learn-github-packages/introduction-to-github-… 
